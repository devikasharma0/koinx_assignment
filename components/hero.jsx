...
import SideHero from './ui/heroside';
...
export const Landing = async () => {
    ...
    return (
        <div className="bg-[#EFF2F5] px-3 lg:px-[56px] pb-[50px]">
            <RouteText/>
            <div className="flex justify-center items-start  gap-5">
                <div className="w-full h-96 lg:h-[710px] bg-white rounded overflow-hidden">
                    <Trading />
                </div>


                <div className="w-[426px] bg-transparent hidden  xl:flex flex-col justify-center items-center gap-5 ">

                    <div className="h-[515px] w-full bg-[#0052FE] rounded-lg py-8 px-12 flex flex-col justify-start items-center gap-10">
